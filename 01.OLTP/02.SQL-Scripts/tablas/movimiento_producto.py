...
for i in range(1,5000+1):
  ...
  a = "INSERT INTO movimiento_producto (id_movimiento, fecha, id_tipo_movimiento, id_empleado, id_estante_origen, id_estante_destino) VALUES ("
  a += str(id_movimiento)+","
  a += "'"+fecha+"',"
